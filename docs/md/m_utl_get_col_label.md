...
# 
# File Reference: m_utl_get_col_label.sas

### Utilities

##### Utility macro to obtain column label attribute from a table.

***

### Description
The macro is used to obtain the attribute label information from a given column in a table. The macro can be used to get the column label from within a data step, or used standalone. The result information is directly given back from the macro.
...
### Returns
* The label value for a given column.
