...
| Input | worksheet | Parameter to specify the name to be exported by the macro. If the parameter value is omitted the worksheet value is equal to the BASE_DS table name. |
...
***
*This document was generated on 13.09.2023 at 19:02:58  by Paul's SAS&reg; Toolbox macro: m_hdr_crt_md_file.sas (v21.1.04)*
