...
data _null_;
   put 'NOTE: Diese text wird nicht angezeigt';
run;
...
data _null_;
   put 'NOTE: Diese text wird angezeigt!';
run;
```
...
***
*This document was generated on 28.03.2021 at 09:53:51  by Paul's SAS&reg; Toolbox macro: m_hdr_crt_md_file.sas (v21.1.03)*
