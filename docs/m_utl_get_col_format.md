...
### Description
The macro is used to obtain the attribute format information from a given column in a table. The macro can be used to get the column format from within a data step, or standalone. The result information is directly given back from the macro.
...
***
*This document was generated on 27.09.2021 at 15:28:48  by Paul's SAS&reg; Toolbox macro: m_hdr_crt_md_file.sas (v21.1.04)*
